# Este es el mismo codigo de la practica 1 que corria en pyton 3.11
# Para esta practica 2 se utilizo una version anterior de python, la 3.10 en un entorno virtual
